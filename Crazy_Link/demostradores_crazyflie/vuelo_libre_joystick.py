    ...
    def control_loop(self):
        ...
        while self.working:
                    ...
                    if self.camera:
                        try:
                            ...
                            if not self.camera.esta_grabando():
                                ...
                                if ruta_video:
                                    print(f"🎬 Botón 1 → GRABANDO VIDEO (10s): {ruta_video}")
                                else:
                                    print("🎬 Botón 1 → Error al iniciar grabación de video")
                            else:
                                print("🎬 Botón 1 → Ya hay una grabación en curso")
                        except Exception as e:
                            print(f"🎬 Error al grabar video: {e}")
                    else:
                        print("🎬 Botón 1 → Cámara no disponible")
            ...
            if self.joystick.get_button(1) == 1:
                ...
                print("Botón 2 → RTL activado")
                time.sleep(0.5)

            # BOTÓN 3: ROTAR CONTINUAMENTE (mientras se mantiene presionado)
